...
namespace Prototype
{
    public static class DBManager<TEntity> where TEntity : class
    {
        ...
        public static List<dynamic> ExecuteDynamic(string sql, object param = null, CommandType type = CommandType.StoredProcedure)
        {
        ...
        public static int ExecuteSingle(string sql, object param = null, CommandType type = CommandType.StoredProcedure)
        {
            using (IDbConnection db = GetOpenConnection())
            {
